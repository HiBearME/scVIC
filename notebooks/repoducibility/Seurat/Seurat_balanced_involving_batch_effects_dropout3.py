...
print(ARI_Seurat_Louvain)
np.save("saved/ARI_Seurat_Louvain_balanced_involving_batch_effects_dropout3.npy", ARI_Seurat_Louvain)

print("NMI_Seurat_Louvain: ")
print(NMI_Seurat_Louvain)
np.save("saved/NMI_Seurat_Louvain_balanced_involving_batch_effects_dropout3.npy", NMI_Seurat_Louvain)

print("ACC_Seurat_Louvain: ")
print(ACC_Seurat_Louvain)
np.save("saved/ACC_Seurat_Louvain_balanced_involving_batch_effects_dropout3.npy", ACC_Seurat_Louvain)     

print("BatchMixing_Seurat_Louvain: ")
print(BatchMixing_Seurat_Louvain)
np.save("saved/BatchMixing_Seurat_Louvain_balanced_involving_batch_effects_dropout3.npy", BatchMixing_Seurat_Louvain)