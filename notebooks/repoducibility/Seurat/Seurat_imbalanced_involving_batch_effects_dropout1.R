...
path = "/Users/Healthy/Desktop/final/scripts and results/generate simulated datasets/data/Imalanced Datasets Involving Batch Effects"
save_path = "/Users/Healthy/Desktop/final/scripts and results/Seurat/pcs/Imbalanced Datasets Involving Batch Effects"
...
for(ratio in ratios){
  for(dropout in dropouts){
    for(duplicate in duplicates){
      ...
      save_path_ratios <- paste(save_path, paste("ratio", ratio, sep = ""), sep = "/")
