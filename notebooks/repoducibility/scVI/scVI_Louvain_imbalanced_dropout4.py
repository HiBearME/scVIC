...
for i_ratio in range(5):
    for i_duplicate in range(10):
        ...
        vae = VAE(gene_dataset.nb_genes, n_latent=10)
...
print(ARI_scVI_Louvain)
np.save("saved/ARI_scVI_Louvain_imbalanced_dropout4.npy", ARI_scVI_Louvain)

print("NMI_scVI_Louvain: ")
print(NMI_scVI_Louvain)
np.save("saved/NMI_scVI_Louvain_imbalanced_dropout4.npy", NMI_scVI_Louvain)

print("ACC_scVI_Louvain: ")
print(ACC_scVI_Louvain)
np.save("saved/ACC_scVI_Louvain_imbalanced_dropout4.npy", ACC_scVI_Louvain)
