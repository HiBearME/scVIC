...
print(ARI_scVI_Louvain)
np.save("saved/ARI_scVI_Louvain_balanced_dropout5.npy", ARI_scVI_Louvain)

print("NMI_scVI_Louvain: ")
print(NMI_scVI_Louvain)
np.save("saved/NMI_scVI_Louvain_balanced_dropout5.npy", NMI_scVI_Louvain)

print("ACC_scVI_Louvain: ")
print(ACC_scVI_Louvain)
np.save("saved/ACC_scVI_Louvain_balanced_dropout5.npy", ACC_scVI_Louvain)
