...
print(ARI_scVI_Louvain)
np.save("saved/ARI_scVI_Louvain_balanced_involving_batch_effects_dropout3.npy", ARI_scVI_Louvain)

print("NMI_scVI_Louvain: ")
print(NMI_scVI_Louvain)
np.save("saved/NMI_scVI_Louvain_balanced_involving_batch_effects_dropout3.npy", NMI_scVI_Louvain)

print("ACC_scVI_Louvain: ")
print(ACC_scVI_Louvain)
np.save("saved/ACC_scVI_Louvain_balanced_involving_batch_effects_dropout3.npy", ACC_scVI_Louvain)

print("BatchMixing_scVI_Louvain: ")
print(BatchMixing_scVI_Louvain)
np.save("saved/BatchMixing_scVI_Louvain_balanced_involving_batch_effects_dropout3.npy", BatchMixing_scVI_Louvain)
