...
print("ARI_scVAE: ")
print(ARI_scVAE)
np.save("saved/ARI_scVAE_balanced_dropout4.npy", ARI_scVAE)

print("NMI_scVAE: ")
print(NMI_scVAE)
np.save("saved/NMI_scVAE_balanced_dropout4.npy", NMI_scVAE)

print("ACC_scVAE: ")
print(ACC_scVAE)
np.save("saved/ACC_scVAE_balanced_dropout4.npy", ACC_scVAE)