...
print("ARI_scVAE: ")
print(ARI_scVAE)
np.save("saved/ARI_scVAE_imbalanced_dropout2.npy", ARI_scVAE)

print("NMI_scVAE: ")
print(NMI_scVAE)
np.save("saved/NMI_scVAE_imbalanced_dropout2.npy", NMI_scVAE)

print("ACC_scVAE: ")
print(ACC_scVAE)
np.save("saved/ACC_scVAE_imbalanced_dropout2.npy", ACC_scVAE)