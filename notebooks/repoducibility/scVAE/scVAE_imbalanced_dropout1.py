...
for i_ratio in range(5):
    for i_duplicate in range(10):
        ...
        if not os.path.exists("data/ratio" + str(i_ratio + 1) + "/dropout" + str(i_dropout + 1)):
            os.makedirs("data/ratio" + str(i_ratio + 1) + "/dropout" + str(i_dropout + 1))
        pd.DataFrame(X).to_csv("data/ratio" + str(i_ratio + 1) + "/dropout" + str(i_dropout + 1) +"/counts_duplicate" + str(i_duplicate + 1) + ".tsv", sep='\t', header=False, index=False)
        cluster_number = 5  
        
        train(
            "data/ratio" + str(i_ratio + 1) + "/dropout" + str(i_dropout + 1) +"/counts_duplicate" + str(i_duplicate + 1) + ".tsv", 
            ...
            data_directory="calculate_data/imbalanced/ratio" + str(i_ratio + 1) + "/dropout" + str(i_dropout + 1),
            models_directory="models/imbalanced/ratio" + str(i_ratio + 1) + "/dropout" + str(i_dropout + 1)
        )
        ...
        ARI_scVAE[i_ratio, i_duplicate] = ARI        
        NMI_scVAE[i_ratio, i_duplicate] = NMI
        ACC_scVAE[i_ratio, i_duplicate] = accuracy
        
print("ARI_scVAE: ")
print(ARI_scVAE)
np.save("saved/ARI_scVAE_imbalanced_dropout1.npy", ARI_scVAE)

print("NMI_scVAE: ")
print(NMI_scVAE)
np.save("saved/NMI_scVAE_imbalanced_dropout1.npy", NMI_scVAE)

print("ACC_scVAE: ")
print(ACC_scVAE)
np.save("saved/ACC_scVAE_imbalanced_dropout1.npy", ACC_scVAE)