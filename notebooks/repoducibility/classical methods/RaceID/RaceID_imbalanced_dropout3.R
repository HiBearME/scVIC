...
for(ratio in ratios){
  for(dropout in dropouts){
    for(duplicate in duplicates){
      ...
      ari[ratio, duplicate] <- race_list[1]
      nmi[ratio, duplicate] <- race_list[2]
    }
  }
}

save(ari, file="/Users/Healthy/Desktop/final/scripts and results/classical methods/savedARI_RaceID_imbalanced_dropout3.rda")
save(nmi, file="/Users/Healthy/Desktop/final/scripts and results/classical methods/savedNMI_RaceID_imbalanced_dropout3.rda")