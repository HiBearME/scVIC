...
for(ratio in ratios){
  for(dropout in dropouts){
    for(duplicate in duplicates){
      ...
      ari[ratio, duplicate] <- soup_list[1]
      nmi[ratio, duplicate] <- soup_list[2]
    }
  }
}

save(ari, file="/Users/Healthy/Desktop/final/scripts and results/classical methods/savedARI_SOUP_imbalanced_dropout2.rda")
save(nmi, file="/Users/Healthy/Desktop/final/scripts and results/classical methods/savedNMI_SOUP_imbalanced_dropout2.rda")