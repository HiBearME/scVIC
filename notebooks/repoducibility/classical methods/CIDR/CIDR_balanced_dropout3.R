...
for(cluster in clusters){
  for(dropout in dropouts){
    for(duplicate in duplicates){
      ...
      ari[cluster, duplicate] <- cidr_list[1]
      nmi[cluster, duplicate] <- cidr_list[2]
    }
  }
}

save(ari, file="/Users/Healthy/Desktop/final/scripts and results/classical methods/savedARI_CIDR_balanced_dropout3.rda")
save(nmi, file="/Users/Healthy/Desktop/final/scripts and results/classical methods/savedNMI_CIDR_balanced_dropout3.rda")