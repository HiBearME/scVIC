...
print("ARI_scVIC: ")
print(ARI_scVIC)
np.save("saved/ARI_scVIC_balanced_involving_batch_effects_dropout5.npy", ARI_scVIC)

print("NMI_scVIC: ")
print(NMI_scVIC)
np.save("saved/NMI_scVIC_balanced_involving_batch_effects_dropout5.npy", NMI_scVIC)

print("ACC_scVIC: ")
print(ACC_scVIC)
np.save("saved/ACC_scVIC_balanced_involving_batch_effects_dropout5.npy", ACC_scVIC)

print("BatchMixing_scVIC: ")
print(BatchMixing_scVIC)
np.save("saved/BatchMixing_scVIC_balanced_involving_batch_effects_dropout5.npy", BatchMixing_scVIC)

print("ARI_scVIC_Louvain: ")
print(ARI_scVIC_Louvain)
np.save("saved/ARI_scVIC_Louvain_balanced_involving_batch_effects_dropout5.npy", ARI_scVIC_Louvain)

print("NMI_scVIC_Louvain: ")
print(NMI_scVIC_Louvain)
np.save("saved/NMI_scVIC_Louvain_balanced_involving_batch_effects_dropout5.npy", NMI_scVIC_Louvain)

print("ACC_scVIC_Louvain: ")
print(ACC_scVIC_Louvain)
np.save("saved/ACC_scVIC_Louvain_balanced_involving_batch_effects_dropout5.npy", ACC_scVIC_Louvain)      

print("BatchMixing_scVIC_Louvain: ")
print(BatchMixing_scVIC_Louvain)
np.save("saved/BatchMixing_scVIC_Louvain_balanced_involving_batch_effects_dropout5.npy", BatchMixing_scVIC_Louvain)