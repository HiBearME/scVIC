...
print("ARI_scVIC: ")
print(ARI_scVIC)
np.save("saved/ARI_scVIC_balanced_dropout3.npy", ARI_scVIC)

print("NMI_scVIC: ")
print(NMI_scVIC)
np.save("saved/NMI_scVIC_balanced_dropout3.npy", NMI_scVIC)

print("ACC_scVIC: ")
print(ACC_scVIC)
np.save("saved/ACC_scVIC_balanced_dropout3.npy", ACC_scVIC)

print("ARI_scVIC_Louvain: ")
print(ARI_scVIC_Louvain)
np.save("saved/ARI_scVIC_Louvain_balanced_dropout3.npy", ARI_scVIC_Louvain)

print("NMI_scVIC_Louvain: ")
print(NMI_scVIC_Louvain)
np.save("saved/NMI_scVIC_Louvain_balanced_dropout3.npy", NMI_scVIC_Louvain)

print("ACC_scVIC_Louvain: ")
print(ACC_scVIC_Louvain)
np.save("saved/ACC_scVIC_Louvain_balanced_dropout3.npy", ACC_scVIC_Louvain)            