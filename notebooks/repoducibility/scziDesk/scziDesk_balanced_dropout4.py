...
for i_cluster in range(5):
    for i_duplicate in range(10):
        ...
        ARI_scziDesk[i_cluster, i_duplicate] = ARI        
        NMI_scziDesk[i_cluster, i_duplicate] = NMI
        ACC_scziDesk[i_cluster, i_duplicate] = accuracy
        
        ARI_scziDeskKmeans[i_cluster, i_duplicate] = kmeans_ARI
        NMI_scziDeskKmeans[i_cluster, i_duplicate] = kmeans_NMI
        ACC_scziDeskKmeans[i_cluster, i_duplicate] = kmeans_accuracy
        
print("ARI_scziDesk: ")
print(ARI_scziDesk)
np.save("saved/ARI_scziDesk_balanced_dropout4.npy", ARI_scziDesk)

print("NMI_scziDesk: ")
print(NMI_scziDesk)
np.save("saved/NMI_scziDesk_balanced_dropout4.npy", NMI_scziDesk)

print("ACC_scziDesk: ")
print(ACC_scziDesk)
np.save("saved/ACC_scziDesk_balanced_dropout4.npy", ACC_scziDesk)
                                                         
print("ARI_scziDeskKmeans: ")
print(ARI_scziDeskKmeans)
np.save("saved/ARI_scziDeskKmeans_balanced_dropout4.npy", ARI_scziDeskKmeans)

print("NMI_scziDeskKmeans: ")
print(NMI_scziDeskKmeans)
np.save("saved/NMI_scziDeskKmeans_balanced_dropout4.npy", NMI_scziDeskKmeans)

print("ACC_scziDeskKmeans: ")
print(ACC_scziDeskKmeans)
np.save("saved/ACC_scziDeskKmeans_balanced_dropout4.npy", ACC_scziDeskKmeans)