...
save_dir="result_imbalanced_dropout3"
...
print("ARI_DESC: ")
print(ARI_DESC)
np.save("saved/ARI_DESC_imbalanced_dropout3.npy", ARI_DESC)

print("NMI_DESC: ")
print(NMI_DESC)
np.save("saved/NMI_DESC_imbalanced_dropout3.npy", NMI_DESC)

print("ACC_DESC: ")
print(ACC_DESC)
np.save("saved/ACC_DESC_imbalanced_dropout3.npy", ACC_DESC)

print("BatchMixing_DESC: ")
print(BatchMixing_DESC)
np.save("saved/BatchMixing_DESC_imbalanced_dropout3.npy", BatchMixing_DESC)                                                    
