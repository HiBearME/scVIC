...
save_dir="result_balanced_dropout5"
...
print("ARI_DESC: ")
print(ARI_DESC)
np.save("saved/ARI_DESC_balanced_dropout5.npy", ARI_DESC)

print("NMI_DESC: ")
print(NMI_DESC)
np.save("saved/NMI_DESC_balanced_dropout5.npy", NMI_DESC)

print("ACC_DESC: ")
print(ACC_DESC)
np.save("saved/ACC_DESC_balanced_dropout5.npy", ACC_DESC)

print("BatchMixing_DESC: ")
print(BatchMixing_DESC)
np.save("saved/BatchMixing_DESC_balanced_dropout5.npy", BatchMixing_DESC) 
